        ...
        return (
           ...
           <div style={{width: jsonData ? "200px" : "50px"}} className="sidebar">
               ...
               <div  className="link" >
                           ...
                           <FontAwesomeIcon icon={faMagnifyingGlass} className="magnifyingGlass" style={{display: jsonData? "block" : "none"}}/>
               </div>
               <div className="link" >
                          <img src={HotTopics} alt="insightsHotTopicsExplorerIcon"  width="30" height="35"/>
                           ...
                           <FontAwesomeIcon icon={faFireFlameCurved} className="flameCurved" style={{display: jsonData? "block" : "none"}}/>
